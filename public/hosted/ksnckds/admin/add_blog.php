...
if (isset($_POST['add_blog'])) {
    ...
    $slug = strtolower($slug); // مهم يحول لحروف صغيرة
    // $slug = preg_replace('/[^a-z0-9\s-]/', '', $slug);
      $slug = preg_replace('/[^\x{0600}-\x{06FF}a-z0-9\s-]/u', '', $slug);
    ...
    $sql = "INSERT INTO blogs VALUES (null , '$title', '$slug', '$details', '$new_image_name' , '$category_id', '$created_at')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800 text-center">Add blog</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Details</label>
                                    <textarea class="form-control" name="details" rows="5" placeholder="Enter Details"></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Image</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" class="form-control">
                                        ...
                                        <?php
                                        $sql_select_category = "SELECT * FROM categoris";
