  ...
  <div class="container">
    ...
    <div class="row g-4 justify-content-center" id="categoriesGrid">
      ...
      <!-- Category 1: Technology -->
       <?php 
      $sql_get_catigory = "SELECT * FROM categoris";
      $result_categoris = mysqli_query($conn , $sql_get_catigory);
      

       while ($row_categoris = mysqli_fetch_assoc($result_categoris)) {
      ...
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="category-card cat-1" id="catTech" role="button" tabindex="0"
          ...
          <h5><?php echo $row_categoris['name'] ?></h5>
          <p><?php echo $row_categoris['description']?></p>
